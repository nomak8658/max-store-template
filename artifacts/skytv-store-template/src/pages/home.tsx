...
const CSS = `
  ...
  *,*::before,*::after{font-family:'Cairo',sans-serif;box-sizing:border-box;margin:0;padding:0;}
  ...
  .mq-inner{display:inline-flex;flex-shrink:0;will-change:transform;direction:ltr;
      ...
      <div dir="rtl" style={{ minHeight: "100vh", background: "#080808" }}>
        ...
        <div className="main-pad" style={{ maxWidth: 1280, margin: "0 auto" }}>
          ...
          <div className="mq-wrap">
            ...
            {/* single inline-flex with doubled content → translateX(-50%) loops perfectly */}
            <div className="mq-inner" style={{ gap: 48 }}>
